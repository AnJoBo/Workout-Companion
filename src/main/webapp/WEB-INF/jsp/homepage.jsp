...
<c:url var="userUpdate" value="/homepage/${currentUser.userName}" />
<a href="${userUpdate}"><button>Update Profile</button></a>

<!DOCTYPE HTML>
<html>
<head>
<title>Gym Companion | Home</title>
...
<body>
	...
	<div class="footer-top">
		<ul class="twitter_footer">
			<li><i class="twt_icon"> </i>
				<p>
					aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud
					exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea
					commodo consequat. Duis autem vel <span class="m_6">2 days
						ago</span>
				</p>
				<div class="clear"></div></li>
		</ul>
	...
	<div class="copyright">
		<div class="container">
			<div class="copy">
				<p>
					© 2018 Your Gym Inc <a href="#" target="_blank"></a>
				</p>
			</div>
			<div class="social">
				<ul>
